    ...
    public partial class MainV2 : Form
    {
        ...
        public class burntkermitmenuicons : menuicons
        {
            public override Image fd
            {
                get 
                {
                    if (File.Exists($"C:Users/USER/Documents/AERO360/GCS360/Resources/light_flightdata_icon.png"))
                        return Image.FromFile($"C:Users/USER/Documents/AERO360/GCS360/Resources/light_flightdata_icon.png");
                    else
            ...
            public override Image fp
            {
                get
                {
                    if (File.Exists($"C:Users/USER/Documents/AERO360/GCS360/Resources/flightdata.png"))
                        return Image.FromFile($"C:Users/USER/Documents/AERO360/GCS360/Resources/flightdata.png");
                    else
        ...
        private void MenuArduPilot_Click(object sender, EventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://aero360.co.in/");
            }
            catch
            {
                CustomMessageBox.Show("Failed to open url https://aero360.co.in/");
            }
        }
